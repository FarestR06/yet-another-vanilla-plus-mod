    ...
    public static class Item extends FabricTagProvider.ItemTagProvider {
        ...
        private void buildingBlockTags() {
            ...
            valueLookupBuilder(ItemTags.LOGS_THAT_BURN)
                    .addOptionalTag(YavpmTags.Items.APPLE_LOGS)
                    .addOptionalTag(YavpmTags.Items.PERSIMMON_LOGS)
                    .addOptionalTag(YavpmTags.Items.PRICKLE_LOGS);
    ...
    public static class Block extends FabricTagProvider.BlockTagProvider {
        ...
        private void woodenBlockTags() {
            ...
            valueLookupBuilder(BlockTags.LOGS_THAT_BURN)
                    .addOptionalTag(YavpmTags.Blocks.APPLE_LOGS)
                    .addOptionalTag(YavpmTags.Blocks.PERSIMMON_LOGS)
                    .addOptionalTag(YavpmTags.Blocks.PRICKLE_LOGS);
