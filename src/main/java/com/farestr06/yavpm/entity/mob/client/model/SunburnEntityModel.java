...
public class SunburnEntityModel extends EntityModel<LivingEntityRenderState> {
	...
	public static TexturedModelData getTexturedModelData() {
		...
		ModelPartData body = modelPartData.addChild("body", ModelPartBuilder.create().uv(0, 8).cuboid(0.0F, -4.0F, -4.0F, 0.0F, 8.0F, 8.0F, new Dilation(0.0F))
				.uv(-8, 16).cuboid(-4.0F, 0.0F, -4.0F, 8.0F, 0.0F, 8.0F, new Dilation(0.0F)), ModelTransform.origin(0.0F, 16.0F, 0.0F));
        ...
        modelPartData.addChild("head", ModelPartBuilder.create().uv(0, 25).cuboid(-3.0F, -9.0F, -4.25F, 6.0F, 1.0F, 0.0F, new Dilation(0.0F)), ModelTransform.origin(0.0F, 24.0F, 0.0F));
